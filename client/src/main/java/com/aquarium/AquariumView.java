...
public class AquariumView extends Pane {
    ...
    public void addFish(Fish fish) {
        try {
            ...
            // Movement move = new Movement(25,50,20,10,4);
            // fish.addMovement(move);
            // Movement move2 = new Movement(25, 45,20,10, 4);
            // fish.addMovement(move2);
            // Movement move3 = new Movement(10, 25, 20,10,4);
            // fish.addMovement(move3);
